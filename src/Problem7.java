...
public class Problem7 {
    ...
    public static boolean isOK(String obj, String[] strs) {
        if(obj.isEmpty()) {
            return true;
        }
        else {
            for(int i = 1; i < obj.length() + 1; i++) {
                if(Arrays.asList(strs).contains(obj.substring(0, i))) {
                    if(isOK(obj.substring(i), ArrayUtils.removeElement(strs, obj.substring(0, i)))) {
                        return true;
                    }
                }
            }
    ...
    public static String findLongest(String[] strs) {
        ...
        for(int i = 0; i < strs.length - 1; i++) {
            if(isOK(strs[i], Arrays.copyOfRange(strs, i + 1, strs.length))) {
                return strs[i];
            }
        }
        return "";
    ...
    //Take notes on how to implement the comparator class. Also as I'm not using hashmap to track the results, my
    // algorithm won't be too efficient
